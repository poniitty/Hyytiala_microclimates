...
f <- list.files("data",pattern = "data_", full.names = T, recursive = T)
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-25")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-26")))
probls <- c(as_date(as_date("2020-07-23"):as_date("2020-10-27")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-24")))
probls <- c(as_date(as_date("2020-04-25"):as_date("2020-10-27")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-08-25")))
probls <- c(as_date(as_date("2020-05-16"):as_date("2020-10-28")),
            as_date(as_date("2021-04-14"):as_date("2021-09-23")))
hattu <- c()
